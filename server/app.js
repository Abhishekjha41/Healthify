...
app.post("/personalized-care", (req, res) => {
  const { userPreferences } = req.body;
  const insights = `Here are some insights based on your preferences: ${JSON.stringify(
    userPreferences
  )}`;
  res.json({ insights });
});

// Privacy & Secure Endpoint
app.get("/api/private-secure", (req, res) => {
